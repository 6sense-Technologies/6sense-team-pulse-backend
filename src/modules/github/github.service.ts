...
import { GitRepo } from '../user-depreciated/schemas/GitRepo.schema';
import mongoose, { Model } from 'mongoose';
import { User } from '../user-depreciated/schemas/user.schema';
import { InjectQueue } from '@nestjs/bullmq';
import { Queue } from 'bullmq';
import { Cron } from '@nestjs/schedule';
import { GitContribution } from '../user-depreciated/schemas/GitContribution.schema';
