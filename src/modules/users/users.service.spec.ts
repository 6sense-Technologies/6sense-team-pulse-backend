...
import { Project } from './enums/user.enum';
import { UserService } from './users.service';

// import { Model } from 'mongoose';
import { ConfigService } from '@nestjs/config';
import { Organization } from 'src/schemas/Organization.schema';
import { OrganizationProjectUser } from 'src/schemas/OrganizationProjectUser.schema';
import { OrganizationUserRole } from 'src/schemas/OrganizationUserRole.schema';
import { Role } from 'src/schemas/Role.schema';
import { UserProject } from 'src/schemas/UserProject.schema';
import { Users } from 'src/schemas/users.schema';
import { Project as ProjectDB } from '../../schemas/Project.schema';
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getModelToken(ProjectDB.name),
          useValue: {},
        },
        {
          provide: getModelToken(UserProject.name),
          useValue: {},
        },
        {
